...
public class SweepCommand {
    ...
    private static int whiteAdd(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        if (Registry.ITEM.getKey(itemStack.getItem()) != null) {
            Static.config.getItemsClean().addItemEntitiesWhitelist(Registry.ITEM.getKey(itemStack.getItem()).toString());
    ...
    private static int whiteDel(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        var itemStack = player.getMainHandItem();
        if (Registry.ITEM.getKey(itemStack.getItem()) != null) {
            Static.config.getItemsClean().delItemEntitiesWhitelist(Registry.ITEM.getKey(itemStack.getItem()).toString());
            ConfigHandler.onChange();
