...
public class SweepCommand {
    ...
    private static int itemWhiteAdd(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        //#if MC < 12000
        if (Registry.ITEM.getKey(itemStack.getItem()) != null) {
            ModConfig.INSTANCE.getItem().addItemEntitiesWhitelist(Registry.ITEM.getKey(itemStack.getItem()).toString());
            //#else
            //$$ if (BuiltInRegistries.ITEM.getKey(itemStack.getItem()) != null) {
            //$$ ModConfig.INSTANCE.getItem().addItemEntitiesWhitelist(BuiltInRegistries.ITEM.getKey(itemStack.getItem()).toString());
            //#endif
    ...
    private static int itemWhiteDel(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        //#if MC < 12000
        if (Registry.ITEM.getKey(itemStack.getItem()) != null) {
            ModConfig.INSTANCE.getItem().delItemEntitiesWhitelist(Registry.ITEM.getKey(itemStack.getItem()).toString());
            //#else
            //$$ if (BuiltInRegistries.ITEM.getKey(itemStack.getItem()) != null) {
            //$$ ModConfig.INSTANCE.getItem().delItemEntitiesWhitelist(BuiltInRegistries.ITEM.getKey(itemStack.getItem()).toString());
            //#endif
            ModConfig.INSTANCE.save();
    ...
    private static int entityWhiteAdd(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        //#if MC < 12000
        if (Registry.ENTITY_TYPE.get(entityName) != null) {
            //#else
            //$$ if (BuiltInRegistries.ENTITY_TYPE.get(entityName) != null) {
            //#endif
